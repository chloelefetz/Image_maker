...
def boite_rotation(canvas, d):
    ...
    fenetre_rotation.attributes('-topmost', True)
...
def boite_miroir_vertical(canvas, d):
    ...
    fenetre_mir_vertical.attributes('-topmost', True)
...
def boite_miroir_horizontal(canvas, d):
    ...
    fenetre_mir_horizontal.attributes('-topmost', True)
...
def boite_symetrie_centrale(canvas, d):
    ...
    fenetre_sym_centrale.attributes('-topmost', True)
...
def boite_symetrie_verticale(canvas, d):
    ...
    fenetre_sym_verticale.attributes('-topmost', True)
...
def boite_symetrie_horizontale(canvas, d): 
    ...
    fenetre_sym_horizontale.attributes('-topmost', True)
