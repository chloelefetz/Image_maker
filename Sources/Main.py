...
from redimensionner import boite_redimensionner
...
menuBar.add_cascade(label="Redimensionner", menu=menuRedimensionner, command=lambda: boite_redimensionner(canvas, text_resolution, d))
...
menuRedimensionner.add_command(label="Redimensionner", command=lambda:boite_redimensionner(canvas, text_resolution, d))
...
button_collage = tk.Button(frame_outil, text = " Retour", image=photo_retour, compound=tk.LEFT, width=150, bg="lightgray", anchor = "w", command=lambda:retour_arriere(canvas, text_resolution, d))
button_collage.pack()
...
button_collage = tk.Button(frame_outil, text = " Revenir à l'originale", image=photo_retour_debut, compound=tk.LEFT, width=150, bg="lightgray", anchor = "w", command=lambda:retour_debut(canvas, text_resolution, d))
button_collage.pack()
image_rogner = Image.open("image_logiciel\_rogner.png")
photo_rogner = ImageTk.PhotoImage(image_rogner)
button_rogner = tk.Button(frame_outil, text = " Rogner", image=photo_rogner, compound=tk.LEFT, width=150, bg="lightgray", anchor = "w", command=lambda:boite_rogner_image(canvas, text_resolution, d))
button_rogner.pack()
