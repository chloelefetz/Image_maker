...
def boite_rogner_image(canvas, text_resolution, d):
    """
    ...
    fenetre_rogner.attributes('-topmost', True)
    
    # Création du bouton Valider
    ajouter_bouton = tk.Button(fenetre_rogner, text="Valider", command=lambda:(rogner_image(canvas, text_resolution, d), fenetre_rogner.destroy()))
    ajouter_bouton.pack()
...
def rogner_image(canvas, text_resolution, d):
    """
